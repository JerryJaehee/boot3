...
<div class="container mt-4">
	...
	<div class="row mt-4">
		<form action="update" method="post" enctype="multipart/form-data">
		  <div class="row mb-3">
		    <div class="col-sm-10">
		      <input type="hidden" value="${vo.productNum}" name="productNum" class="form-control" id="productNum">
		    </div>
		  </div>
		  <div class="row mb-3">
		 ...
		 <div class="row mb-3">
		  ...
		  <div class="row mb-3">
			<div class="form-check">
			  <input class="form-check-input sale" type="radio" value="1" ${vo.sale eq 1?'checked':''}  name="sale">
			  <label class="form-check-label" for="flexRadioDefault1">
			    판매
			  </label>
			</div>
			<div class="form-check">
			  <input class="form-check-input sale" type="radio" value="0" ${vo.sale eq 0?'checked':''} name="sale">
		...
		<div id="fileResult">
		  ...
		  <button type="submit" class="btn btn-primary" id="addBtn">Write</button>
		</form>
